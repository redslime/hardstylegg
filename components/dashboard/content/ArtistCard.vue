  ...
  <div class="bg-base-300 rounded-lg shadow p-2 flex flex-col justify-start border border-neutral/50"
    ...
    <div class="h-[130px] w-[130px]">
      ...
      <img class="w-full h-full overflow-hidden object-cover rounded-xl"
           @load="imgLoaded = true" v-if="artist.image" :src="artist.getImageUrl()" alt="" />
      <div v-if="!artist.image" class="w-full min-h-[130px] rounded-xl bg-base-300 flex items-center justify-center border-2 border-dashed border-base-content/20">
